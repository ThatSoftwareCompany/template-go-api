...
The current foundation release is `0.2.8`, which includes the `0.2.5` hardening work plus lifecycle module-normalization and legacy bridge fixes. The immutable `v0.2.6` and `v0.2.7` tags were created before the release metadata was finalized; new generated repositories should use `v0.2.8`. The next planned releases are:
