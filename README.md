...
The current foundation release is `0.2.7`, which includes the `0.2.5` hardening work plus lifecycle module-normalization and legacy bridge fixes. `v0.2.6` is retained as an immutable tag from before the lifecycle hotfix was merged; new generated repositories should use `v0.2.7`. The next planned releases are:
